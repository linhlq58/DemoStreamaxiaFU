package com.botbanhang.botlive.base;
...
import com.botbanhang.botlive.Util;
import com.botbanhang.botlive.entity.FunctionConfigModel;
import com.botbanhang.botlive.utils.FileUtils;
import com.botbanhang.botlive.view.SelectDataActivity;
...
public abstract class BaseFaceUnityActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected Button mBtnLive;

    protected StreamaxiaStreamer streamaxiaStreamer;
    ...
    protected void onRenderBefore(FURenderInputData inputData) {
        if (isStreaming) {
            streamaxiaStreamer.sendVideoFrames(inputData.getImageBuffer().getBuffer());
        }
    }
    ...
    private final OnGlRendererListener mOnGlRendererListener = new OnGlRendererListener() {
        ...
        public void onRenderAfter(@NonNull FURenderOutputData outputData, @NotNull FURenderFrameData frameData) {
            ...
            /*if (isStreaming) {
                *//*byte[] streamData = outputData.getImage().getBuffer();
                if (streamData != null) {
                    streamaxiaStreamer.sendVideoFrames(streamData);
                }*//*

                Log.d("ImageData", outputData.printMsg());
            }*/
        }
